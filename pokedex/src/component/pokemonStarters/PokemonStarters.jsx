      ...
      {generations.map((generation) => {
        ...
        return (
          <div key={generation.generation}>
            {/* Utilise un élément parent (ici, <div>) */}
            <h3>{generation.generation}</h3>
            {generation.pokemons.map((pokemonGen) => {
              return (
                <>
                  <div key={pokemonGen.id}>
                    {/* Utilise un élément parent pour chaque Pokémon */}
                    <PokemonCard pokemonCardDetails={pokemonGen} />
                  </div>
                </>
              );
            })}
